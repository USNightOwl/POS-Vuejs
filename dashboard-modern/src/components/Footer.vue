<template lang="">
  <v-footer color="#1F1F1F" class="">
    <div class="px-4 py-2 w-100 bgTop">
    ...
    <div class=" d-flex w-100 bgMidum px-4 pb-10">
      <v-row>
        ...
        <v-col col="12" sm="3">
          ...
          <v-img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqGK3diR3Zi-mnOXEaj-3ewmFyRYVxGzVzZw&s" height="150"></v-img>
        </v-col>
      </v-row>
    </div>
